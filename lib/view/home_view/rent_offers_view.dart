...
class _RentOffersViewState extends State<RentOffersView> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("خدمات التأجير",textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),),
      ),
      body: Padding(
