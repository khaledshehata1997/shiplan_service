            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Text('خدمه الأستقدام',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.white),),
                ],
              ),
            ),
          ),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Text('خدمه التأجير',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.white),),
                    ],
                  ),
                ),
              ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const  Text('جميع العروض',style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),),
                  ],
                ),
                Container(
                    alignment: Alignment.topRight,
                    margin: const EdgeInsets.only(right: 15),
                    child:const  Text('العروض',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)),
              ],
            ),
            const SizedBox(height: 15,),
            SizedBox(
